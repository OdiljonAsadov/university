...
<div><a class="btn btn-primary" style="width: 150px" href="/room">Back</a></div>
            ...
            <form action="/room/edit/{{ $room->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                            ...
                            <div class="form-room">
                                ...
                                <textarea class="form-control" name="description" cols="30" rows="4">{{ $room->description }}</textarea>
                            </div>
